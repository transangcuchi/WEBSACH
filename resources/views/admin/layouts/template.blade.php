    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('admindashboard') }}">
                ...
                <div class="sidebar-brand-text mx-3">Web<sup>BOOK</sup></div>
            </a>
            ...
            <!-- Nav Item - Sản phẩm -->
            <li class="nav-item">
                <a class="nav-link" href="{{ route('themsanpham') }}">
                    <i class="fas fa-fw fa-chart-area"></i>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle" src="../images/hinhadminlogin.jpg">
                            </a>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Nhóm 12 &copy; Laravel Website 2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
